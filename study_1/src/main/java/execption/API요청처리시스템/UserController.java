...
public class UserController {
    ...
    public static class ApiResponse<T> {
        // http status 200 - 500 번대 (200 ok, 201 created 클라이언트, 400 401 402 403 404 405 (프론트엔드), 500 서버 에러)
    ...
    /**
     * 오류 응답 클래스
     * 내부 클래스로 만들어서 static 을 쓴 거임 빠져나와있으면 쓸 필요 X
     * DTO는 record class 로 만들면 더 좋음!
     */
