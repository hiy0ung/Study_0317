...
//        Address address1 = new Address("street1", "Seoul", "12345");
//        Address address2 = new Address("street2", "Seoul", "67890");
//        UserProfile user1 = new UserProfile("123", "김이름", "aaa@eee.eee", address1);
//        UserProfile user2 = new UserProfile("456", "박이름", "bbb@eee.eee", address2);
//        UserProfileService userProfileService = new UserProfileService();
//
//        userProfileService.addUser(user1);
//        userProfileService.addUser(user2);
//
//        System.out.println(userProfileService.findUserById("123").orElse(null));
//
//        userProfileService.updateUserEmail("123", "ccc@eee.eee");
//        System.out.println(user1);
//
//        Product p1 = new Product("1", "마우스", 100, new BigDecimal(10000));
//        Product p2 = new Product("2", "키보드", 100, new BigDecimal(50000));
//        Product p3 = new Product("3", "모니터", 100, new BigDecimal(100000));
//
//        ProductInventoryService inventory = new ProductInventoryService();
//        inventory.addProduct(p1);
//        inventory.addProduct(p2);
//        inventory.addProduct(p3);
//        System.out.println("상품 1: " + inventory.infoProduct("1"));
//        System.out.println("상품 2: " + inventory.infoProduct("2"));
//        System.out.println("상품 3: " + inventory.infoProduct("3"));
//
//        System.out.println("마우스 10% 할인: " + inventory.calculateDiscountedPrice("1", 0.1));
//
//        inventory.processOrder("2", 10);
//        System.out.println("키보드 주문 후 수량: " + inventory.infoProduct("2"));
//        inventory.processOrder("3", 101);
//        System.out.println("모니터 주문 후 수량: " + inventory.infoProduct("3"));
//    }
public static void main(String[] args) {
