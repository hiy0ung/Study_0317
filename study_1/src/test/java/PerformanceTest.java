...
public class PerformanceTest {
    ...
    void compareNullCheckPerformance() {
        ...
        System.out.printf("Old Style executiontime: %d ms%n", (endTime - startTime) / 10000000);
        System.out.printf("New Style executiontime: %d ms%n", (endTime1 - startTime1) / 10000000);
    }
